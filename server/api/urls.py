...
urlpatterns = [
    ...
    path("categories/<str:search>/", ServiceCategoryList.as_view(), name="view_categories"),
    ...
    path("services/<str:search>/", ServiceList.as_view(), name="view_services"),
    ...
    path("workers/<str:search>/", WorkerList.as_view(), name="view_workers"),
